...
import { Eye, EyeOff, Gem, Mail, Lock, AlertCircle } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-luxury flex items-center justify-center px-4 py-20">
      ...
      <div className="relative w-full max-w-md">
        ...
        {/* Form Card — wrapped in Suspense because LoginForm uses useSearchParams */}
        <Suspense fallback={<div className="glass-dark rounded-2xl border border-white/10 p-8 h-64 animate-pulse" />}>
          <LoginForm />
        </Suspense>
